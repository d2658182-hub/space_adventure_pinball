function CEndPanel(oSpriteBg){
    ...
    this._init = function(oSpriteBg){
        ...
        _oButRestart = new CGfxButton(160, 80, s_oSpriteLibrary.getSprite('but_restart'), _oPanelContainer);
        _oButRestart.addEventListener(ON_MOUSE_UP, this._onRestart, this);
        _oButRestart.pulseAnimation();

        _oButHome = new CGfxButton(-160, 80, s_oSpriteLibrary.getSprite('but_home'), _oPanelContainer);
       ...
       if(s_isLogin === false)
        ...
        s_oMain.createY8Logo("g_menulogo", CANVAS_WIDTH/2, CANVAS_HEIGHT-210)
    ...
    this.createSubmitScoreBtn = function()
    {
        ...
        _pLeaderboardBtn = {x: 0, y: 80};  
       _oLeaderboardBtn1 = new CGfxButton(_pLeaderboardBtn.x,_pLeaderboardBtn.y,oSprite, _oPanelContainer);
       _oLeaderboardBtn1.addEventListener(ON_MOUSE_UP, this._showLeaderboard, this);
    }
    this.createLeaderboardBtn = function()
    {
        var oSprite = s_oSpriteLibrary.getSprite('but_leaderboard_med');
        _pLeaderboardBtn = {x: 0, y: 80};  
       _oLeaderboardBtn = new CGfxButton(_pLeaderboardBtn.x,_pLeaderboardBtn.y,oSprite, _oPanelContainer);
