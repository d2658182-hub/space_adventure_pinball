function CCreditsPanel(){
    ...
    this._init = function(){
        ...
        var oTitle = new createjs.Text("DEVELOPED BY"," 40px "+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        oTitle.y = -80;
        ...
        var oLink = new createjs.Text("www.codethislab.com"," 40px "+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        oLink.y = 80;
