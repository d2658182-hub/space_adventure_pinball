function CMain(oData){
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'start_game',loop:false,volume:1, ingamename: 'start_game'});
        aSoundsInfo.push({path: './sounds/',filename:'launch',loop:false,volume:1, ingamename: 'launch'});
        aSoundsInfo.push({path: './sounds/',filename:'toggle',loop:false,volume:1, ingamename: 'toggle'});
        aSoundsInfo.push({path: './sounds/',filename:'gate',loop:false,volume:1, ingamename: 'gate'});
        aSoundsInfo.push({path: './sounds/',filename:'bumper',loop:false,volume:1, ingamename: 'bumper'});
        aSoundsInfo.push({path: './sounds/',filename:'jumper',loop:false,volume:1, ingamename: 'jumper'});
        aSoundsInfo.push({path: './sounds/',filename:'pinball_button_on',loop:false,volume:1, ingamename: 'pinball_button_on'});
        aSoundsInfo.push({path: './sounds/',filename:'pinball_button_off',loop:false,volume:1, ingamename: 'pinball_button_off'});
        aSoundsInfo.push({path: './sounds/',filename:'in_hole',loop:false,volume:1, ingamename: 'in_hole'});
        aSoundsInfo.push({path: './sounds/',filename:'out_hole',loop:false,volume:1, ingamename: 'out_hole'});
        aSoundsInfo.push({path: './sounds/',filename:'flipper',loop:false,volume:1, ingamename: 'flipper'});

        ////////WIN SOUNDS
        aSoundsInfo.push({path: './sounds/',filename:'all_letters_complete',loop:false,volume:1, ingamename: 'all_letters_complete'});
        aSoundsInfo.push({path: './sounds/',filename:'all_lights_on_1',loop:false,volume:1, ingamename: 'all_lights_on_1'});
        aSoundsInfo.push({path: './sounds/',filename:'all_lights_on_2',loop:false,volume:1, ingamename: 'all_lights_on_2'});
        aSoundsInfo.push({path: './sounds/',filename:'letter',loop:false,volume:1, ingamename: 'letter'});
        aSoundsInfo.push({path: './sounds/',filename:'bonus_win_1',loop:false,volume:1, ingamename: 'bonus_win_1'});
        aSoundsInfo.push({path: './sounds/',filename:'bonus_win_2',loop:false,volume:1, ingamename: 'bonus_win_2'});
        aSoundsInfo.push({path: './sounds/',filename:'ball_out',loop:false,volume:1, ingamename: 'ball_out'});
    ...
    this._loadImages = function(){
        ...
        s_oSpriteLibrary.addSprite("but_leaderboard_med","./sprites/leaderBoar_Btn_med.png");
    ...
    {
       var y8logoMc = (new createjs.Bitmap(document.createElement('canvas')));
...
var s_URLlocation;
var s_gameName = "pinball_space_adventure"
