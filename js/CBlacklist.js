...
function CBlacklist(istate, gN){
    ...
    this._init = function(){
            ...
            var _y8logoMc = ((y8logoMc)?createBitmap(y8logoMc):new createjs.Container());
            ...
            _y8logoMc.y = CANVAS_HEIGHT/2 
             ...
             //var tempText3 = new createjs.Text("", "bold 22px "+FONT2, "#000")
              var _blackListText = new createjs.Text("http://www.y8.com/games/"+gameName,"bold 30px Arial", "#990000");
            ...
            _blackListText.y = tempText1.y + 35
            tempText2.x = CANVAS_WIDTH/2;
            tempText2.y = tempText1.y + 70
